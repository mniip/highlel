...
#define dumpregs(r) \
	(printf("RAX:%016lx  RBX:%016lx  RCX:%016lx  RDX:%016lx  RSP:%016lx  RBP:%016lx  RSI:%016lx  RDI:%016lx\n",r.A.rx,r.B.rx,r.C.rx,r.D.rx,r.SP.rx,r.BP.rx,r.SI.rx,r.DI.rx),\
	printf("R 8:%016lx  R 9:%016lx  R10:%016lx  R11:%016lx  R12:%016lx  R13:%016lx  R14:%016lx  R15:%016lx\n",r.r[0].rx,r.r[1].rx,r.r[2].rx,r.r[3].rx,r.r[4].rx,r.r[5].rx,r.r[6].rx,r.r[7].rx),\
